...
namespace Jramke\FluidUI\Utility;
...
class ComponentUtility
{
    ...
    public static function getSettings(): array
    {
        ...
        $fluidUISettings = $settings['plugin.']['tx_fluidui.']['settings.'] ?? [];

        if (empty($fluidUISettings)) {
            $fluidUISettings = $settings['lib.']['contentElement.']['settings.'] ?? [];
        }

        return is_array($fluidUISettings) ? GeneralUtility::removeDotsFromTS($fluidUISettings) : $fluidUISettings;
    }
}
